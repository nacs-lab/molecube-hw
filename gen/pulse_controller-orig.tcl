...
#
# pulse_controller-orig.tcl: Tcl script for re-creating project 'pulse_controller_v5_0'
#
#
...
#
# 1. This project restoration tcl script (pulse_controller-orig.tcl) that was generated.
#
...
set project_name "pulse_controller_v5_0"
...
set script_file "pulse_controller-orig.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../build/custom_ip"]"
...
set file "hdl/clock_controller.sv"
...
set file "hdl/spi_controller.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "used_in" -value "synthesis simulation" -objects $file_obj
set_property -name "used_in_implementation" -value "0" -objects $file_obj

set file "pulse_controller_5.0/component.xml"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pulse_controller_v5_0" -objects $obj
