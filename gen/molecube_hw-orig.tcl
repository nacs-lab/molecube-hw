...
#
# molecube_hw-orig.tcl: Tcl script for re-creating project 'molecube_hw'
#
#
...
#
# 1. This project restoration tcl script (molecube_hw-orig.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/yuyichao/projects/vivado/molecube-hw/build/molecube_hw/molecube_hw.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/yuyichao/projects/vivado/molecube-hw/molecube-hw.xdc"
#
#*****************************************************************************************
...
set script_file "molecube_hw-orig.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../build/molecube_hw"]"
...
set_property -name "board_part" -value "xilinx.com:zc702:part0:1.1" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../build/custom_ip/pulse_controller_5.0"]" $obj
...
set files [list \
 "[file normalize "$origin_dir/../build/molecube_hw/molecube_hw.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
]
...
set file "[file normalize "$origin_dir/../molecube-hw.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../molecube-hw.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  nigrp.org:user:pulse_controller:5.0\
  ...
  # Create ports
  set clock_out [ create_bd_port -dir O clock_out ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins pulse_controller_0/s00_axi]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins pulse_controller_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net pulse_controller_0_clock_out [get_bd_ports clock_out] [get_bd_pins pulse_controller_0/clock_out]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins pulse_controller_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x73000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_controller_0/s00_axi/reg0] SEG_pulse_controller_0_reg0
