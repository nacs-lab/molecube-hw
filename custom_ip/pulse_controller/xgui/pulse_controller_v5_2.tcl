...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "U_TTL_IN_WIDTH"
...
proc update_PARAM_VALUE.U_TTL_IN_WIDTH { PARAM_VALUE.U_TTL_IN_WIDTH } {
	# Procedure called to update U_TTL_IN_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.U_TTL_IN_WIDTH { PARAM_VALUE.U_TTL_IN_WIDTH } {
	# Procedure called to validate U_TTL_IN_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.U_TTL_IN_WIDTH { MODELPARAM_VALUE.U_TTL_IN_WIDTH PARAM_VALUE.U_TTL_IN_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.U_TTL_IN_WIDTH}] ${MODELPARAM_VALUE.U_TTL_IN_WIDTH}
}
