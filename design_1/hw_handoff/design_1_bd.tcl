...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clock_in_pin [ create_bd_port -dir I -type clk -freq_hz 100000000 clock_in_pin ]
  set clock_out1_pin [ create_bd_port -dir O clock_out1_pin ]
  set dds_FUD_pin [ create_bd_port -dir O -from 1 -to 0 dds_FUD_pin ]
  set dds_addr2_pin [ create_bd_port -dir O -from 6 -to 0 dds_addr2_pin ]
  set dds_addr_pin [ create_bd_port -dir O -from 6 -to 0 dds_addr_pin ]
  set dds_control2_pin [ create_bd_port -dir O -from 2 -to 0 dds_control2_pin ]
  set dds_control_pin [ create_bd_port -dir O -from 2 -to 0 dds_control_pin ]
  set dds_cs_pin [ create_bd_port -dir O -from 21 -to 0 dds_cs_pin ]
  set dds_data2_pin [ create_bd_port -dir IO -from 15 -to 0 dds_data2_pin ]
  set dds_data_pin [ create_bd_port -dir IO -from 15 -to 0 dds_data_pin ]
  set pulse_io_pin [ create_bd_port -dir O -from 31 -to 0 pulse_io_pin ]
  set spi0_clk [ create_bd_port -dir O spi0_clk ]
  set spi0_cs [ create_bd_port -dir O -from 0 -to 0 spi0_cs ]
  ...
  set pulse_controller_0 [ create_bd_cell -type ip -vlnv nigrp.org:nigrp:pulse_controller:5.2 pulse_controller_0 ]
  set_property -dict [ list \
   CONFIG.C_S00_AXI_ADDR_WIDTH {9} \
 ] $pulse_controller_0

  # Create instance: result_fifo_0, and set properties
  set result_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:fifo_generator:13.2 result_fifo_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins pulse_controller_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net pulse_controller_0_result_fifo_rd [get_bd_intf_pins pulse_controller_0/result_fifo_rd] [get_bd_intf_pins result_fifo_0/FIFO_READ]
  connect_bd_intf_net -intf_net pulse_controller_0_result_fifo_wr [get_bd_intf_pins pulse_controller_0/result_fifo_wr] [get_bd_intf_pins result_fifo_0/FIFO_WRITE]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins fifo_generator_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pulse_controller_0/s00_axi_aclk] [get_bd_pins result_fifo_0/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pulse_controller_0_clock_out [get_bd_ports clock_out1_pin] [get_bd_pins pulse_controller_0/clockout]
  connect_bd_net -net pulse_controller_0_dds_FUD [get_bd_ports dds_FUD_pin] [get_bd_pins pulse_controller_0/dds_FUD]
  connect_bd_net -net pulse_controller_0_dds_addr [get_bd_ports dds_addr_pin] [get_bd_pins pulse_controller_0/dds_addr]
  connect_bd_net -net pulse_controller_0_dds_addr2 [get_bd_ports dds_addr2_pin] [get_bd_pins pulse_controller_0/dds_addr2]
  ...
  connect_bd_net -net pulse_controller_0_spi_clk [get_bd_ports spi0_clk] [get_bd_pins pulse_controller_0/spi_sclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins fifo_generator_0/srst] [get_bd_pins result_fifo_0/rst] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
  connect_bd_net -net spi0_miso_1 [get_bd_ports spi0_miso] [get_bd_pins pulse_controller_0/spi_miso]

  # Create address segments
  assign_bd_address -offset 0x73000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_controller_0/S00_AXI/S00_AXI_reg] -force
