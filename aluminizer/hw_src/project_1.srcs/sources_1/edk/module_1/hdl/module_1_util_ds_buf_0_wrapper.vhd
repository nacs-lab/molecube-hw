-------------------------------------------------------------------------------
-- module_1_util_ds_buf_0_wrapper.vhd
-------------------------------------------------------------------------------
library IEEE;
...
entity module_1_util_ds_buf_0_wrapper is
  port (
  ...
  attribute x_core_info of module_1_util_ds_buf_0_wrapper : entity is "util_ds_buf_v1_01_a";

end module_1_util_ds_buf_0_wrapper;

architecture STRUCTURE of module_1_util_ds_buf_0_wrapper is
