...
module spi_controller(clock, reset, write_enable, busy, opcode, operand,
                      spi_cs, spi_mosi, spi_miso, spi_clk, result_data, result_WrReq);
   ...
   always @(posedge clock) begin
      if (reset) begin
         ...
         if (spi_clk_edges == 0) begin //assert cs
            ...
            // spi_clk_reg = 0 means this is a rising edge
            // spi_clk_reg = 1 means this is a falling edge
