   ...
   always @(slv_reg_read_sel)
     begin
        case (slv_reg_read_sel)
          ...
          32'b00000000010000000000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000001000000000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000100000000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000010000000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000001000000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000100000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000010000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000001000000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000100000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000010000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000001000000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000100000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000010000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000001000000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000100000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000010000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000001000000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000000100000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000000010000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000000001000 : slv_ip2bus_data <= 0;
          32'b00000000000000000000000000000100 : slv_ip2bus_data <= 0;
